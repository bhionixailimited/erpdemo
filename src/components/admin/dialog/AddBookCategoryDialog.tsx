...
const AddBookCategoryDialog = ({ feeName, designation, Dmutate }: Props) => {
    ...
    onSubmit: async (values) => {
      try {
        const response = await mutate({
          path: `${
            designation
              ? `book-category/update/${designation?._id}`
...
export default AddBookCategoryDialog;
