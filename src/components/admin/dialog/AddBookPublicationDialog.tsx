...
const AddBookPublicationDialog = ({ feeName, designation, Dmutate }: Props) => {
    ...
    onSubmit: async (values) => {
      try {
        const response = await mutate({
          path: `${
            designation
              ? `publication/update/${designation?._id}`
              : `publication/create`
          }`,
...
export default AddBookPublicationDialog;
