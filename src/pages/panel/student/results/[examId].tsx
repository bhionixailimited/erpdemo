...
const ReportDetails = () => {
  ...
  const { data: studentMarkDetails, isValidating: markLoading } =
    useSWRFetch<StudentMarkDataType>(
      user?._id && query?.examId && `exam/result/${query?.examId}/${user?._id}`
    );
      ...
      <>
        ...
        >
          ...
          {markLoading ? (
            ...
            <>
              <div className="w-full flex flex-col md:flex-row justify-evenly gap-10 items-center py-5">
                <div className="flex gap-1 flex-col">
                    ...
                    <TableBody>
                      ...
                      >
                        ...
                        <TableCell align="center">
                          <div className="flex text-center">
                            Total Grade Point :{" "}
                            {studentMarkDetails?.data?.totalGradePoint?.toFixed(
                              1
                            )}
                          </div>
                        </TableCell>
                        <TableCell align="center">
                          <div className="flex text-center">
                            SGPA :{" "}
                            {studentMarkDetails?.data?.testGpa?.toFixed(2)}
                          </div>
                        </TableCell>
                      </TableRow>
                    </TableBody>
...
export default withProtectedStudent(ReportDetails);
