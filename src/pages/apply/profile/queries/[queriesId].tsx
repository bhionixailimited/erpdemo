...
const QueriesMessage = () => {
  ...
  } = useSWRFetch<SupportMessageDataType>(`register-enquiry/${queriesId}`);
  ...
  const handleReplySupport = async () => {
    try {
      ...
      const response = await mutate({
        path: "register-enquiry/reply-to-support",
        method: "POST",
        body: JSON.stringify({
          message,
          enquiryId: queriesId,
