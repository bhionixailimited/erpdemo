...
const EditBranchDrawer = ({ open, onClose, mutate }: any) => {
  const { data, isValidating } = useSWRFetch<Data>(open && `branch/${open}`);
        ...
        <div className="w-full">
          <div className="flex items-center justify-between p-4 border-b ">
            <div className="flex items-center text-slate-700 font-semibold text-xl gap-1 uppercase">
              ...
              <h3 className="tracking-wide text-center">Edit Branch</h3>
            </div>
          </div>
