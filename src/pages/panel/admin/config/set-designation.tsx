...
const SetDesignation = () => {
  ...
  const { data, isValidating, error, mutate } =
    useSWRFetch<dataType>("designation");
  ...
  return (
    <div className="w-full">
      <PrivateLayout title="Set Designation | Manage">
        <div className="px-4 mt-4">
          <div className="mb-4 flex bg-indigo-50 p-4 rounded-md shadow-md justify-between">
            <h2 className="text-theme text-3xl font-bold ">Designations</h2>

            <div className="">
              <AddDesignationDialog feeName="Add" Dmutate={mutate} />
            </div>
          </div>
          <MaterialTable
            components={{
...
export default withProtectedAdmin(SetDesignation);
