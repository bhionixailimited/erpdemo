...
const ICONS = {
  ...
  WaveBackground: (props: IconType) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" {...props}>
      <path
        fill="currentColor"
        fillOpacity="1"
        d="M0,160L80,149.3C160,139,320,117,480,133.3C640,149,800,203,960,229.3C1120,256,1280,256,1360,256L1440,256L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"
      ></path>
    </svg>
  ),
  Loading: (props: IconType) => (
    <svg
      stroke="currentColor"
      fill="currentColor"
      strokeWidth="0"
