...
const Publication = () => {
  ...
  const { data, isValidating, error, mutate } =
    useSWRFetch<dataType>("publication");
      ...
      <PrivateLayout title="Set Book Publication | Manage">
        <div className="px-4 mt-4">
          <div className="mb-4 flex bg-indigo-50 p-4 rounded-md shadow-md justify-between">
            <h2 className="text-theme text-3xl font-bold ">Book Publication</h2>

            <div className="">
              <AddBookPublicationDialog feeName="Add" Dmutate={mutate} />
            </div>
          </div>
          <MaterialTable
            components={{
...
export default withProtectedAdmin(Publication);
