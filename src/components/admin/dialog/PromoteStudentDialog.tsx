...
const PromoteStudentDialog = ({
          ...
          if (result.isConfirmed)
            new Promise(async (resolve, reject) => {
              ...
              const response = await department({
                path: `batch/academic/${studentID || _id}`,
                method: "POST",
  ...
  return (
    <div className="w-fit">
        ...
        <div className="w-full flex flex-col  ">
          ...
          >
            ...
            <div className="flex items-center justify-center">
              <Button className="hover:ring-theme">Promote</Button>
            </div>
          </form>
        </div>
      </CustomDialog>
      {type !== "BATCH" ? (
        <Button
          className="shadow-none text-xs md:text-base whitespace-nowrap !py-4 !min-w-fit !px-4"
          onClick={() => {
        ...
        <Button className="mr-2 " onClick={() => setOpenDialog(true)}>
          Promote
        </Button>
      )}{" "}
    </div>
