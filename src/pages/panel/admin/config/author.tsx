...
import AddBookPublicationDialog from "components/admin/dialog/AddBookPublicationDialog";
import AddBookAuthorDialog from "components/admin/dialog/AddBookAuthorDialog";
...
const Author = () => {
  ...
  const { data, isValidating, mutate } = useSWRFetch<dataType>("author");
  ...
  return (
    <div className="w-full">
      <PrivateLayout title="Set Book Publication | Manage">
        <div className="px-4 mt-4">
          <div className="mb-4 flex bg-indigo-50 p-4 rounded-md shadow-md justify-between">
            <h2 className="text-theme text-3xl font-bold ">Book Author</h2>

            <div className="">
              <AddBookAuthorDialog feeName="Add" Dmutate={mutate} />
            </div>
          </div>
          <MaterialTable
            components={{
...
export default withProtectedAdmin(Author);
